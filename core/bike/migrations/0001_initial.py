    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basketball_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bike.bikeclass')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bike_registrations', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('rating', models.IntegerField()),
                ('arena', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='bike.arena')),
            ],
        ),
        migrations.CreateModel(
            name='ClassSchedule',
            fields=[
                ...
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bike.trainer')),
            ],
        ),
    ]
