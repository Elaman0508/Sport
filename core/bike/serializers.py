...
class RegistrationSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        ref_name = 'BikeRegistrationSerializer'
...
class FeedbackSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        ref_name = 'BikeFeedbackSerializer'
...
class TrainerSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        ref_name = 'BikeTrainerSerializer'
...
class ClassScheduleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        ref_name = 'BikeClassScheduleSerializer'
...
class ClubInfoSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        ref_name = 'BikeClubInfoSerializer'
