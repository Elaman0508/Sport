    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField()),
                ('arena', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='yoga.arena')),
            ],
        ),
        migrations.CreateModel(
            name='ClassSchedule',
            fields=[
                ...
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yoga.trainer')),
            ],
        ),
        migrations.CreateModel(
            name='Registration',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Yoga_registrations', to=settings.AUTH_USER_MODEL)),
                ('basketball_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yoga.yogaclass')),
            ],
        ),
    ]
