...
class Registration(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='boxing_registrations')
    basketball_class = models.ForeignKey(BoxClass, on_delete=models.CASCADE)
