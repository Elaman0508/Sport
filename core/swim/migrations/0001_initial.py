    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arena', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='swim.arena')),
            ],
        ),
        migrations.CreateModel(
            name='Registration',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Swim_registrations', to=settings.AUTH_USER_MODEL)),
                ('basketball_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='swim.swimclass')),
            ],
        ),
        migrations.CreateModel(
            name='ClassSchedule',
            fields=[
                ...
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='swim.trainer')),
            ],
        ),
    ]
