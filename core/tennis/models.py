...
class TennisClass(models.Model):
...
class Registration(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='Tennis_registrations')
    basketball_class = models.ForeignKey(TennisClass, on_delete=models.CASCADE)
