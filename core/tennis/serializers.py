...
class RegistrationSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        ref_name = 'TennisRegistrationSerializer'
...
class ReviewSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        ref_name = 'TennisReviewSerializer'
...
class ArenaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        ref_name = 'TennisArenaSerializer'
...
class FeedbackSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        ref_name = 'TennisFeedbackSerializer'
...
class TrainerSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        ref_name = 'TennisTrainerSerializer'
...
class ClassScheduleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        ref_name = 'TennisClassScheduleSerializer'
...
class ClubInfoSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        ref_name = 'TennisClubInfoSerializer'
